"""
Django settings for xyzmarni_47483 project.
...
ROOT_URLCONF = 'xyzmarni_47483.urls'
...
WSGI_APPLICATION = 'xyzmarni_47483.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "xyzmarni_47483 API",
    "DESCRIPTION": "API documentation for xyzmarni_47483 App",
    "VERSION": "v1",
}
